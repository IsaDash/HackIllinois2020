    ...
    render () {
        var AREAS_MAP = {
            ...
            areas: [
                ...
                { name: "Illini Union", shape: "poly", coords: [1265,722,1428,864,1268,943,1084,799], preFillColor: 'rgba(255, 255, 255, 0.2)', lineWidth:2, fillColor: 'rgba(255, 255, 255, 0.5)' ,href:'./ClassInfo' },
                { name: "Grainger", shape: "poly", coords: [702,482,795,569,1028,458,964,369], preFillColor: 'rgba(255, 255, 255, 0.2)', lineWidth:2, fillColor: 'rgba(255, 255, 255, 0.5)'  ,href:'./ClassInfo'},
